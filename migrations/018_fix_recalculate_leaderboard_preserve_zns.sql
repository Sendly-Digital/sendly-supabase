-- Fix recalculate_leaderboard_stats to preserve ZNS domains
-- The function was doing TRUNCATE which deleted all zns_domain values
-- This migration updates the function to save and restore ZNS domains
...
BEGIN
  ...
  SELECT LOWER(TRIM(sender_address)) AS sender_address, zns_domain
  ...
  LEFT JOIN temp_zns_domains tzd ON tzd.sender_address = a.sender_address;
