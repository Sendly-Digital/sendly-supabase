-- Update recalculate_leaderboard_stats_graph_true() to be chain-aware
-- Requires chain_id on gift_cards_graph and leaderboard_stats_graph_true
...
BEGIN
  ...
  -- Recalculate from gift_cards_graph (per chain_id)
